...
const Login = () => {
  ...
  return (
    <div className="flex justify-center items-center h-screen w-full p-4">
      <div className="bg-primary-100 dark:bg-primary-900 flex flex-col gap-4 items-center p-5 rounded-xl shadow-lg w-full max-w-md">
        ...
        >
          ...
          <Button
            ...
            title="login"
            variant={"primary"}
            className="mt-4 !w-full dark:border border-primary-600"
            disabled={isLoading}
          >
