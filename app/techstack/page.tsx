  ...
  const TechStackList = [
    {
      ...
      icon: (
        <svg
          ...
          viewBox="0 0 384 512"
          fill="currentColor"
          className="w-12 h-12 sm:w-28 sm:h-28   fill-red-600 "
        >
    ...
    },
    {
      ...
      icon: (
        <svg
          ...
          viewBox="0 0 384 512"
          fill="currentColor"
          className="w-12 h-12 sm:w-28 sm:h-28  fill-amber-500 "
        >
  ...
  return (
    <main className="container">
      <div className="flex flex-col gap-2  my-12">
        <Typography size="h3/semi-bold">Tech Stack</Typography>
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-3 my-4 mt-20">
